...
class ProductController extends Controller
{
    ...
    public function editProduct($id, $section = 'basic')
    {
        ...
        //@TODO: Change the check from isDigital to !isPhysical
        if (!$myProduct->isPhysical() && $section == 'delivery')
            return redirect()->route('admin.index');

        // physical product cant have digtial section
        //@TODO: Change the check from isPhysical to !isDigital
        if (!$myProduct->isDigital() && $section == 'digital')
            return redirect()->route('admin.index');
