...
class NewShippingRequest extends FormRequest
{
    ...
    {
        return [
            'name' => 'required|string|in:Priority (Tracked),Standard (Not Tracked),Free Shipping (Tracked),Free Shipping (Not Tracked)',
    ...
    public function persist(Product $product = null)
    {
        ...
        $free_shipping = [
            ...
            'Free Shipping (Not Tracked)'
        ];
	    if(in_array($this->name, $free_shipping))
	    {
		    $newShipping->price = 0;
	    }
