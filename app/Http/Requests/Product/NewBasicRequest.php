        ...
        return [
            ...
            'description' => [
                ...
                function ($attribute, $value, $fail) {
                    if (str_word_count($value) > 3500) {
                        $fail($attribute.' longer than 3500 words.');
                    }
                },
            ...
            'rules' => [
                ...
                'string',
                function ($attribute, $value, $fail) {
                    if (str_word_count($value) > 1500) {
                        $fail($attribute.' longer than 1500 words.');
                    }
                },
    ...
    public function persist(Product $currentProduct = null)
    {
        ...
        foreach ($this -> types as $type) {
           if (!auth()->user()->vendor->canUseType($type))
               throw new RequestException('Not allowed purchase type used');
        }
