...
class AdminActionSubscriber
{
    ...
    public function onUserDisputeEscalation(ProductDisputeEscalated $event)
    {
	    Log::enter([
		    'user_id' => $event->initiator->id,
		    'type' => 'escalation',
		    'description' => 'Dispute for Purchase was escalated ',
		    'performed_on' => $event->purchase,
	    ]);
    }
    ...
    public function subscribe($events)
    {
        ...
        $events->listen(
                'App\Events\Purchase\ProductDisputeEscalated',
                'App\Listeners\AdminActionSubscriber@onUserDisputeEscalation'
        );
