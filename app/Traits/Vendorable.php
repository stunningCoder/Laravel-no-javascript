...
trait Vendorable
{
    ...
    {
        if(!$this -> hasPGP())
            throw new RequestException('Hey, wait a sec pal... Add your PGP-Key on your account before becoming a Vendor!');
...
//        }
        ...
        throw_unless($this -> depositedEngouh(), new RequestException("You must deposit enough funds to one of the address!"));
