...
@section('profile-content')
    ...
    <div class="row justify-content-center">
        <div class="col-md-4">
            ...
            @else
                <div class="alert alert-warning text-center">Sparky! You don't have any conversations.</div>
        ...
        <div class="col-md-8">
            @if(!$conversation)
                <h3 class="mb-3">Write Details</h3>
                <hr>
                        ...
                        <div class="card my-2">
                            <div class="card-body">
                                ...
                                @if($message -> isEncrypted())
                                    <textarea readonly class="form-control" rows="5">{{ $message -> getContent() }}</textarea>
