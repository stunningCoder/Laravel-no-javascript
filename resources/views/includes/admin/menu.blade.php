<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
    ...
    @endhasAccess
    @hasAccess('categories')
    <a class="nav-link @isroute('admin.announcement') active @endisroute" href="{{ route('admin.announcement') }}">
    ...
    @hasAccess(['tickets' , 'ticketsmoderation'])
    ...
    @admin
    <a class="nav-link @isroute('admin.elasticsearch.index') active @endisroute @isroute('admin.elasticsearch.index') active @endisroute" href="{{ route('admin.elasticsearch.index') }}">
        <i class="far mr-2 fa-search"></i>
        ElasticSearch
    </a>
    @endadmin
