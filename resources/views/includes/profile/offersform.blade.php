...
<div class="col-md-12 text-center mt-3">
        ...
        @else
            ...
            @if(session('product_type') == 'physical')
                    <a href="{{ route('profile.vendor.product.delivery' ) }}" class="btn btn-outline-primary"><i class="fas fa-chevron-down mr-2"></i>  Next</a>
            @else
                    <a href="{{ route('profile.vendor.product.digital' ) }}" class="btn btn-outline-primary"><i class="fas fa-chevron-down mr-2"></i>  Next</a>
            @endif
