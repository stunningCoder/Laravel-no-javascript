            ...
            <div class="card-body">
                ...
                <div class="row">
                        ...
                        @foreach(\App\User::$permissions as $permission)
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" @if($user -> hasPermission($permission)) checked @endif name="permissions[]" type="checkbox"
                                           value="{{ $permission }}"
                                           id="moderatorCheck">
                    ...
                    <div class="col-md-4">
                        ...
                        @if($user->isVendor())
                            @foreach(\App\User::$vendorPermissions as $vPermission)
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input class="form-check-input" @if($user -> hasPermission($vPermission)) checked @endif name="permissions[]" type="checkbox"
                                               value="{{ $vPermission }}"
                                               id="moderatorCheck">
                                        {{ \App\User::$vendorPermissionsLong[$vPermission] }}
                                    </label>
                                </div>
                            @endforeach
                        @endif
