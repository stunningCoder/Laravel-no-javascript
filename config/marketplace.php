...
return [
     ...
     */
    'market_fee_percent' => env('MARKET_FEE_PERCENT', 7),
    ...
    'posts_per_page' => 24, //put in different places for Tikets , products and etc
    ...
    'multicurreny' => env('SYSTEM_MULTICURRENCY_STATE', false),
    /**
